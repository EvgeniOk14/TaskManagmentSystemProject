...
public class UserService
{
    ...
    /**
     * Метод - registerUser служит для регистрации пользователя.
    ...
    /**
     * Метод для получения пользователя по ID и преобразования его в DTO.
     *
    ...
    public User authenticate(String email, String password)
    {
        ...
        User user = userRepository.findByEmail(email); // Ищем пользователя по email и выбрасываем исключение, если пользователь не найден
        if(user == null)
        {
